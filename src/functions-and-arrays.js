...
console.log(maxOfTwoNumbers(100, 0));
...
function doesWordExist(wordArray, searchWord) {
  return wordArray.indexOf(searchWord) !== -1;
}

const searchWord = "starting";
const result = doesWordExist(words, searchWord);

console.log(`Does "${searchWord}" exist in the array? ${result}`);
...
const result = howManyTimes(words, searchWord);
console.log(`The word "${searchWord}" appears ${result} times.`);
